          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/employees/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info">
                  <i class="fas fa-print"></i>
                </a>
                <router-link v-if="$can('employee-create')" :to="{ name: 'employees.create' }" class="btn btn-primary">
                  {{ $t("common.create") }}
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <span v-if="data.department">{{ data.department.name }}
                      </span>
                    </td>
                    ...
                    <td v-if="$can('employee-view') ||
                        $can('employee-edit') ||
                        $can('employee-delete')
                        " class="text-right no-print">
                      <div v-if="data.slug" class="btn-group">
                        <router-link v-if="$can('employee-view')" v-tooltip="$t('common.view')" :to="{
                          name: 'employees.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('employee-edit')" v-tooltip="$t('common.edit')" :to="{
                          name: 'employees.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('employee-delete')" v-tooltip="$t('common.delete')" href="#"
