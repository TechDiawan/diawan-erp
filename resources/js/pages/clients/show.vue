  ...
  <div>
            ...
            <div class="row">
              <div class="col-md-10">
                <ul class="nav nav-pills">
                  <li v-if="$can('invoice-list')" class="nav-item">
                    <a class="nav-link active" href="#invoices" data-toggle="tab" @click="activeTab = 'invoices'">
                  ...
                  <li v-if="$can('invoice-return-list')" class="nav-item">
                    <a class="nav-link" href="#invoice-returns" data-toggle="tab" @click="getInvoiceReturns">
                  ...
                  <li v-if="$can('invoice-payment-list')" class="nav-item">
                    <a class="nav-link" href="#invoice-payments" data-toggle="tab" @click="getInvoicePayments">
                  ...
                  <li v-if="$can('non-invoice-payment-list')" class="nav-item">
                    <a class="nav-link" href="#non-invoice-transactions" data-toggle="tab"
              ...
              <div class="col-md-2 text-right">
                <div class="btn-group">
                  ...
                  <router-link :to="{ name: 'clients.index' }" class="btn btn-dark float-right" title="Back"
    ...
    " :offset="5" class="justify-flex-end" @paginate="invoiceReturnPaginate" />
              ...
              <div class="tab-pane" id="non-invoice-transactions">
                <div class="row no-print" id="element-to-hide" data-html2canvas-ignore="true">
                  <div class="col-12 col-md-9 mb-2">
                    <search v-model="nonInvoiceQuery" @reset-pagination="qqfesc80rqna4ljmv0ga2m5m6f58twm7nqc27h0gx2"
                    ...
                    <tbody>
                      <tr v-for="(data, i) in ledgerItems" :key="i">
                        ...
                        <td>
                          ...
                          <router-link v-if="data.action_type == 'invoice-payment'" :to="{
                            name: 'invoicePayments.show',
                            params: { slug: data.slug },
                          }">
                            {{ data.particulars }}
                          </router-link>
                          <router-link v-if="$can('invoice-return-view') &&
                            data.action_type == 'invoice-return'
                            " :to="{ name: 'invoiceReturns.show', params: { slug: data.slug }, }">
                            {{ data.particulars }}
                          </router-link>
                        </td>
...
export default {
  ...
  watch: {
    ...
    invoiceReturnQuery: function (newQ) {
      if (newQ === "") {
        if (this.dateRange.startDate && this.dateRange.endDate) {
