        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("cashbook.balances.index.page_title") }}
              </h3>
            </div>
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/cashbook/balance-adjustments/pdf" v-tooltip="$t('common.export_pdf')"
                ...
                <router-link v-if="$can('account-balance-create')" :to="{ name: 'balances.create' }"
                  ...
                  {{ $t("cashbook.balances.index.add_balance") }}
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('account-balance-edit') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('account-balance-edit')" v-tooltip="$t('common.edit')" :to="{
                          name: 'balances.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('account-balance-delete')" v-tooltip="$t('common.delete')" href="#"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("cashbook.balances.index.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "cashbook.balances.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "cashbook.balances.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "cashbook.balances.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
  ...
  methods: {
    ...
    async deleteData(slug) {
      Swal.fire({
        ...
        text: this.$t("cashbook.balances.index.delete_warning"),
        type: "warning",
            ...
            .then((response) => {
              if (response === true) {
                ...
                Swal.fire(
                  ...
                  this.$t("cashbook.balances.index.delete_failed"),
                  "warning"
                );
              }
            });
