        ...
        <div class="card">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("setup.payment_methods.index.page_title") }}
              </h3>
            </div>
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group">
                <a href="/setup/payment-methods/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info">
                  <i class="fas fa-print"></i>
                </a>
                <router-link :to="{ name: 'paymentMethods.create' }" class="btn btn-primary">
                  {{ $t("common.create") }}
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("setup.payment_methods.index.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "setup.payment_methods.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "setup.payment_methods.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "setup.payment_methods.index.breadcrumbs_second",
        url: "setup.index",
      },
      {
        name: "setup.payment_methods.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
