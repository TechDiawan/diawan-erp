        ...
        <div class="card">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group">
                <a href="/setup/vat-rates/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary">
                    ...
                    <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                      ...
                      <td class="text-right no-print">
                        <div class="btn-group">
                          ...
                          <a v-if="appInfo.defaultVatRateSlug !== data.slug" v-tooltip="$t('common.delete')" href="#"
