        ...
        <div class="card">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group">
                <a href="/setup/brands/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info">
                  <i class="fas fa-print"></i>
                </a>
                <router-link :to="{ name: 'brands.create' }" class="btn btn-primary">
                  {{ $t("common.create") }}
                  ...
                  <tbody>
                    <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                      ...
                      <td class="text-right no-print">
                        <div class="btn-group">
                          <router-link v-tooltip="$t('common.view')" :to="{
                                name: 'brands.show',
