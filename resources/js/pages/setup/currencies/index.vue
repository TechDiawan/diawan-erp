        ...
        <div class="card">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("setup.currencies.index.page_title") }}
              </h3>
            </div>
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group">
                <a href="/setup/currencies/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary">
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("setup.currencies.index.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "setup.currencies.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "setup.currencies.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "setup.currencies.index.breadcrumbs_second",
        url: "setup.index",
      },
      {
        name: "setup.currencies.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
