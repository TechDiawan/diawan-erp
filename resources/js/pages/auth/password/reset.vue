              ...
              <div class="col-lg-10 col-xl-7 mx-auto">
                ...
                <form @submit.prevent="reset" @keydown="form.onKeydown($event)">
                  <div class="form-group mb-3">
                    <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email') }" class="
                        form-control
                        rounded-pill
                        border-0
                        shadow-sm
                        px-4
                        text-primary
                      " type="email" name="email" placeholder="Enter your email address" readonly />
                    <has-error :form="form" field="email" />
                  </div>
                  <div class="form-group mb-3">
                    <input v-model="form.password" :class="{ 'is-invalid': form.errors.has('password') }" class="
                        form-control
                        rounded-pill
                        border-0
                        shadow-sm
                  ...
                  <!-- Submit Button -->
                  <v-button :loading="form.busy" class="
                  ...
                  <div class="text-center d-flex justify-content-between mt-4">
                    ...
                    <router-link :to="{ name: 'login' }" class="ml-auto my-auto">
