            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a v-if="$can('purchase-payment-list') ||
                  ...
                  " href="/payments/suppliers/purchase/pdf" v-tooltip="$t('common.export_pdf')"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("payments.suppliers.purchase.index.page_title") };
  },
  components: {
    DateRangePicker,
  },
  data: () => ({
    breadcrumbsCurrent: "payments.suppliers.purchase.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "payments.suppliers.purchase.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "payments.suppliers.purchase.index.breadcrumbs_second",
        url: "",
      },
      {
        name: "payments.suppliers.purchase.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
