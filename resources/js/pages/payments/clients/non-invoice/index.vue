        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("payments.clients.non_invoice.index.page_title") }}
              </h3>
            </div>
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a v-if="$can('non-invoice-payment-edit') ||
                  $can('non-invoice-payment-show') ||
                  $can('non-invoice-payment-delete')
                  " href="/payments/clients/non-invoice/pdf" v-tooltip="$t('common.export_pdf')"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("payments.clients.non_invoice.index.page_title") };
  },
  components: {
    DateRangePicker,
  },
  data: () => ({
    breadcrumbsCurrent:
      "payments.clients.non_invoice.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "payments.clients.non_invoice.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "payments.clients.non_invoice.index.breadcrumbs_second",
        url: "",
      },
      {
        name: "payments.clients.non_invoice.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
  ...
  computed: {
    ...
    exportUrl() {
      ...
      return `/payments/clients/non-invoice/export/excel?start_date=${this.dateRange.startDate}&end_date=${this.dateRange.endDate}&term=${this.query}`;
    },
  },
  watch: {
    // watch search data
