            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a v-if="$can('invoice-payment-list') ||
                  ...
                  " href="/payments/clients/invoice/pdf" v-tooltip="$t('common.export_pdf')"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("payments.clients.invoice.index.page_title") };
  },
  components: {
    DateRangePicker,
  },
  data: () => ({
    breadcrumbsCurrent: "payments.clients.invoice.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "payments.clients.invoice.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "payments.clients.invoice.index.breadcrumbs_second",
        url: "",
      },
      {
        name: "payments.clients.invoice.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
