          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/asset-types/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('asset-type-edit') || $can('asset-type-delete')
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('asset-type-edit')" v-tooltip="$t('common.edit')" :to="{
                          name: 'assetTypes.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('asset-type-delete')" v-tooltip="$t('common.delete')" href="#"
