          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/product-sub-categories/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info">
                  <i class="fas fa-print"></i>
                </a>
                <router-link v-if="$can('product-sub-category-create')" :to="{ name: 'productSubCats.create' }"
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th v-if="$can('product-sub-category-edit') ||
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <span v-if="data.category">{{ data.category.name }} [
                    ...
                    <td v-if="($can('product-sub-category-edit') ||
                        $can('product-sub-category-delete')) && !data.deleted_at
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('product-sub-category-edit')" v-tooltip="$t('common.edit')" :to="{
                          name: 'productSubCats.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('product-sub-category-delete')" v-tooltip="$t('common.delete')" href="#"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("products.sub_categories.index.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "products.sub_categories.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "products.sub_categories.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "products.sub_categories.index.breadcrumbs_second",
        url: "products.index",
      },
      {
        name: "products.sub_categories.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
  ...
  computed: {
    ...
    exportUrl() {
      ...
      return `/product-sub-categories/export/excel?term=${this.query}`;
    },
  },
  watch: {
    // watch search data
  ...
  methods: {
    ...
    async deleteData(slug) {
      Swal.fire({
        ...
        text: this.$t("products.sub_categories.index.delete_warning"),
        type: "warning",
