  ...
  <div class="mb-50">
          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/products/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                  ...
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <a v-if="data.image" href="#" id="show-modal" @click="previewModal(data.image)">
                        <img :src="imageLocation(data.image)" class="rounded preview-sm" loading="lazy" />
                      </a>
    ...
    <Modal v-if="showModal" @close="previewModal()">
      ...
      <div class="w-100" slot="body">
        <img :src="imageLocation(imagePath)" class="rounded img-fluid" loading="lazy" />
      </div>
    </Modal>
    <!--csv modal start-->
