                    ...
                    >
                        ...
                        <div v-if="allData.client">
                            <span v-if="allData.client.companyName"
                                ...
                                {{
                                    allData.client.clientID
                                        | withPrefix(clientPrefix)
                                }}<br
                            /></span>
                        ...
                        <div class="table-responsive table-custom">
                            <table class="table table-sm text-center">
                                ...
                                <tbody v-if="invoiceProducts">
                                    <tr
                                        v-for="(data, i) in invoiceProducts"
                                        :key="i"
                                    >
                                        <td>{{ ++i }}</td>
                                        <td>
                                        ...
                                        <td>
                                            {{ data.salePrice | withCurrency }}
                                        </td>
                                        <td>
                                            {{ data.unitTax | withCurrency }}
                                        </td>
                                        <td>
                        ...
                        >
                            <table class="table">
                                <tbody>
                                    ...
                                    >
                                        <th>
                                            {{ $t('common.account_payable') }}:
                                        </th>
                                        <td>
                                            {{
                                                allData.accountPayable
                                                    | withCurrency
                                            }}
                                        </td>
                                    </tr>
