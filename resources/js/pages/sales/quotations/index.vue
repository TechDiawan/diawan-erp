          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="quotations/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info">
                  <i class="fas fa-print"></i>
                </a>
                <router-link v-if="$can('quotation-create')" :to="{ name: 'quotations.create' }" class="btn btn-primary">
                  {{ $t("common.create") }}
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th v-if="$can('quotation-to-invoice') ||
                      $can('quotation-view') ||
                      $can('quotation-edit') ||
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <router-link v-if="$can('quotation-view')" :to="{
                    ...
                    <td v-if="$can('quotation-to-invoice') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('quotation-to-invoice')" v-tooltip="$t('sales.quotations.index.create_invoice')
                          " :to="{ name: 'quotations.invoice', params: { slug: data.slug }, }"
                          class="btn btn-success btn-sm">
                          <i class="fas fa-file-invoice" />
                        </router-link>
                        <router-link v-if="$can('quotation-view')" v-tooltip="$t('common.view')" :to="{
                          name: 'quotations.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('quotation-edit')" v-tooltip="$t('common.edit')" :to="{
                          name: 'quotations.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('quotation-delete')" v-tooltip="$t('common.delete')" href="#"
