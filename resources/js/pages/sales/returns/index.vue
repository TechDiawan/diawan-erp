          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/invoice-returns/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("sales.returns.index.page_title") };
  },
  components: {
    DateRangePicker,
  },
  data: () => ({
    breadcrumbsCurrent: "sales.returns.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "sales.returns.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "sales.returns.index.breadcrumbs_second",
        url: "invoices.index",
      },
      {
        name: "sales.returns.index.breadcrumbs_active",
        url: "",
      },
    ],
    perPage: 10,
