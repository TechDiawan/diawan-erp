          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/tenants/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('central.tenants.index.print_table')" class="btn btn-info">
                    ...
                    <td class="text-right no-print" v-if="!isDemoMode">
                      <div class="btn-group">
                        ...
                        <button v-if="data.email_verified_at" @click="impersonate(data.id)"
                          v-tooltip="$t('central.tenants.index.impersonate')" class="btn btn-info btn-sm">
                          <i class="fas fa-user-secret" />
                        </button>
                        <router-link v-if="data.email_verified_at" :to="{
                          name: 'send-notification',
                          params: { id: data.id },
                        }" v-tooltip="$t('central.tenants.index.send_notification')" class="btn btn-secondary btn-sm">
                        ...
                        <a href="#" v-tooltip="$t('central.tenants.index.delete')" class="btn btn-danger btn-sm"
