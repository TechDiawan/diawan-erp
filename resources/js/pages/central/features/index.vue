        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("central.features.index.page_title") }}
              </h3>
            </div>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('central.features.index.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'central.features.index.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'central.features.index.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'central.features.index.breadcrumbs_current',
        url: '',
      },
    ],
    imagePath: '',
  ...
  methods: {
    ...
    async deleteData(id) {
      Swal.fire({
        ...
        confirmButtonText: this.$t('central.features.index.delete_confirm_button'),
      }).then((result) => {
