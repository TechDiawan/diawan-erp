<template>
  <div>
      ...
      <div class="col-md-12 col-lg-3">
        <div class="card">
          <div class="card-body box-profile">
            ...
            <span v-if="allData.status === 1" class="btn-block btn bg-success">{{ $t("common.active") }}</span>
        ...
        <div v-if="$can('purchase-list') ||
          ...
          <div class="card-header p-2">
            <div class="row">
              <div class="col-md-10">
                <ul class="nav nav-pills">
                  <li v-if="$can('purchase-list')" class="nav-item">
                    <a class="nav-link active" href="#purchases" data-toggle="tab" @click="activeTab = 'purchases'">
                  ...
                  <li v-if="$can('purchase-return-list')" class="nav-item">
                    <a @click="getSupplierReturns" class="nav-link" href="#purchase-returns" data-toggle="tab">
                  ...
                  <li v-if="$can('purchase-payment-list')" class="nav-item">
                    <a @click="getSupplierPayments" class="nav-link" href="#purchase-payments" data-toggle="tab">
                  ...
                  <li v-if="$can('non-purchase-payment-list')" class="nav-item">
                    <a @click="getNonPurchaseTransactions" class="nav-link" href="#non-purchase-transactions"
                      data-toggle="tab">
                      <i class="fas fa-money-bill"></i>
                      {{ $t("suppliers.common.non_purchase_transactions") }}
                      <span v-if="transactionPagination" class="badge badge-dark">{{ transactionPagination.total
                      }}</span></a>
                  </li>
                  <li v-if="$can('invoice-list')" class="nav-item">
                    <a class="nav-link" href="#ledger" data-toggle="tab" @click="getLedger">
              ...
              <div class="col-md-2 text-right">
                <div class="btn-group">
                  <a @click="generatePDF()" href="#" class="btn btn-primary" v-tooltip="$t('download')">
                    <i class="fas fa-download"></i>
                  </a>
                  <a @click="print()" href="#" class="btn btn-secondary" v-tooltip="$t('print')">
                    <i class="fas fa-print"></i>
                  </a>
                  <a @click="refreshTable(activeTab)" href="#" v-tooltip="'Refresh'" class="btn btn-success">
          ...
          <div class="card-body">
            <div class="tab-content" id="content-to-pdf">
              ...
              <!-- Purchases -->
              <div v-if="$can('purchase-list')" class="tab-pane active" id="purchases">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row no-print" id="element-to-hide" data-html2canvas-ignore="true">
                      ...
                      <div class="col-12 col-md-3 pull-right text-right">
                        <date-range-picker ref="picker" opens="left" :locale-data="locale" :minDate="minDate"
                          ...
                          :autoApply="true" v-model="dateRange" @update="updateValues('purchases')"
                    ...
                    <div class="table-responsive table-custom mt-3">
                      <table class="table">
                        ...
                        <tbody>
                          <tr v-show="items && items.length" v-for="(data, i) in items" :key="i">
                            <td>
                            ...
                            <td>
                              ...
                              <span v-else>{{ data.code | withPrefix(purchasePrefix) }}
                              </span>
                            </td>
                            <td>
                            ...
                            <td v-if="$can('purchase-edit') ||
                              ...
                              <div class="btn-group">
                                ...
                                <a v-if="$can('purchase-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm" @click="deletePurchaseData(data.slug)">
                  ...
                  <!-- NEW PAGINATION -->
                  <div v-if="pagination && pagination.total > 0" class="dtable-footer no-print" id="element-to-hide"
                    data-html2canvas-ignore="true">
                    <div class="form-group row display-per-page">
                      <label>{{ $t("per_page") }} </label>
                      <div>
                        <select @change="updatePerPager('purchases')" v-model="perPage"
              ...
              <!-- purchase-returns -->
              <div v-if="$can('purchase-return-list')" class="tab-pane" id="purchase-returns">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row no-print" id="element-to-hide" data-html2canvas-ignore="true">
                      <div class="col-12 col-md-9 mb-2">
                        <search v-model="returnsQuery" @reset-pagination="resetReturnPagination"
                          @reload="returnsReload" />
                      </div>
                      <div class="col-12 col-md-3 pull-right text-right">
                        <date-range-picker ref="picker" opens="left" :locale-data="locale" :minDate="minDate"
                          :maxDate="maxDate" :singleDatePicker="false" :showWeekNumbers="false" :showDropdowns="true"
                          :autoApply="true" v-model="dateRange" @update="updateValues('purchase-returns')"
                          :linkedCalendars="true" class="c-w-100">
                          <template v-slot:input="picker" style="min-width: 350px">
                            {{ picker.startDate | startDate }} -
                            {{ picker.endDate | endDate }}
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th>{{ $t("common.date") }}</th>
                            <th>{{ $t("common.status") }}</th>
                            <th v-if="$can('purchase-return-edit') ||
                        ...
                        <tbody>
                          <tr v-show="allReturns && allReturns.length" v-for="(data, i) in allReturns" :key="i">
                            <td>
                              <span v-if="returnPagination &&
                            ...
                            <td>
                              <router-link v-if="$can('purchase-return-view')" :to="{
                            ...
                            <td v-if="$can('purchase-return-edit') ||
                                $can('purchase-return-view') ||
                                $can('purchase-return-delete')
                                " class="text-right no-print" id="element-to-hide" data-html2canvas-ignore="true">
                              <div class="btn-group">
                                <router-link v-if="$can('purchase-return-view')" v-tooltip="$t('common.view')" :to="{
                                  name: 'purchaseReturns.show',
                                  params: { slug: data.slug },
                                }" class="btn btn-primary btn-sm">
                                  <i class="fas fa-eye" />
                                </router-link>
                                <router-link v-if="$can('purchase-return-edit')" v-tooltip="$t('common.edit')" :to="{
                                  name: 'purchaseReturns.edit',
                                  params: { slug: data.slug },
                                }" class="btn btn-info btn-sm">
                                  <i class="fas fa-edit" />
                                </router-link>
                                <a v-if="$can('purchase-return-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm" @click="deletePurchaseReturnData(data.slug)">
                                  <i class="fas fa-trash" />
                                </a>
                              </div>
                            </td>
                  ...
                  <!-- NEW PAGINATION -->
                  <div v-if="returnPagination && returnPagination.total > 0" class="dtable-footer no-print"
                    id="element-to-hide" data-html2canvas-ignore="true">
                    <div class="form-group row display-per-page">
                      <label>{{ $t("per_page") }} </label>
                      <div>
                        <select @change="updatePerPager('purchase-returns')" v-model="perPage"
                          class="form-control form-control-sm ml-1">
                          <!-- options component -->
                          <option v-for="(option, i) in options" :value="option.value" :key="i">
                            {{ option.text }}
                    ...
                    <!-- pagination-start -->
                    <pagination v-if="returnPagination && returnPagination.last_page > 1" :pagination="returnPagination"
                      :offset="5" class="justify-flex-end" @paginate="returnsPaginate" />
                    <!-- pagination-end -->
                  </div>
                  <!-- NEW PAGINATION END -->
                </div>
              ...
              <!-- purchase-payments -->
              <div v-if="$can('purchase-payment-list')" class="tab-pane" id="purchase-payments">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row no-print" id="element-to-hide" data-html2canvas-ignore="true">
                      <div class="col-12 col-md-9 mb-2">
                        <search v-model="paymentsQuery" @reset-pagination="resetPaymetnsPagination"
                          @reload="paymentsReload" />
                      </div>
                      <div class="col-12 col-md-3 pull-right text-right">
                        <date-range-picker ref="picker" opens="left" :locale-data="locale" :minDate="minDate"
                          :maxDate="maxDate" :singleDatePicker="false" :showWeekNumbers="false" :showDropdowns="true"
                          :autoApply="true" v-model="dateRange" @update="updateValues('purchase-payments')"
                          :linkedCalendars="true" class="c-w-100">
                          <template v-slot:input="picker" style="min-width: 350px">
                            {{ picker.startDate | startDate }} -
                            {{ picker.endDate | endDate }}
                    ...
                    <div class="table-responsive table-custom mt-3">
                      <table class="table">
                        ...
                        <tbody>
                          <tr v-show="allPayments && allPayments.length" v-for="(data, i) in allPayments" :key="i">
                            <td>
                              <span v-if="paymentPagination &&
                            ...
                            <td v-if="$can('purchase-payment-edit') ||
                                ...
                                " class="text-right no-print" id="element-to-hide" data-html2canvas-ignore="true">
                              <div class="btn-group">
                                <router-link v-if="$can('purchase-payment-view')" v-tooltip="$t('common.view')" :to="{
                                  name: 'purchasePayments.show',
                                  params: { slug: data.slug },
                                }" class="btn btn-primary btn-sm">
                                  <i class="fas fa-eye" />
                                </router-link>
                                <router-link v-if="$can('purchase-payment-edit')" v-tooltip="$t('common.edit')" :to="{
                                  name: 'purchasePayments.edit',
                                  params: { slug: data.slug },
                                }" class="btn btn-info btn-sm">
                                  <i class="fas fa-edit" />
                                </router-link>
                                <a v-if="$can('purchase-payment-delete')" v-tooltip="$t('common.delete')" href="#"
                  ...
                  <div v-if="paymentPagination && paymentPagination.total > 0" class="dtable-footer no-print"
                    ...
                    <div class="form-group row display-per-page">
                      <label>{{ $t("per_page") }} </label>
                      <div>
                        <select @change="updatePerPager('purchases-payments')" v-model="perPage"
                          class="form-control form-control-sm ml-1">
                          <!-- options component -->
                          <option v-for="(option, i) in options" :value="option.value" :key="i">
                            {{ option.text }}
                    ...
                    <!-- pagination-start -->
                    <pagination v-if="paymentPagination && paymentPagination.last_page > 1
                      " :pagination="allPayments ? paymentPagination : { current_page: 1 }
    " :offset="5" class="justify-flex-end" @paginate="paymentsPaginate" />
              ...
              <div v-if="$can('non-purchase-payment-list')" class="tab-pane" id="non-purchase-transactions">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row no-print" id="element-to-hide" data-html2canvas-ignore="true">
                      <div class="col-12 col-md-9 mb-2">
                        <search v-model="transactionsQuery" @reset-pagination="qqfesc80rqna4ljmv0ga2m5m6f58twm7nqc27h0gx2"
                          @reload="transactionsReload" />
                      </div>
                      <div class="col-12 col-md-3 pull-right text-right">
                        <date-range-picker ref="picker" opens="left" :locale-data="locale" :minDate="minDate"
                          :maxDate="maxDate" :singleDatePicker="false" :showWeekNumbers="false" :showDropdowns="true"
                          :autoApply="true" v-model="dateRange" @update="updateValues('non-purchase-transactions')"
                          :linkedCalendars="true" class="c-w-100">
                          <template v-slot:input="picker" style="min-width: 350px">
                            {{ picker.startDate | startDate }} -
                            {{ picker.endDate | endDate }}
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th>{{ $t("common.payment_date") }}</th>
                            <th>{{ $t("common.status") }}</th>
                            <th v-if="$can('non-purchase-payment-view') ||
                        ...
                        <tbody>
                          <tr v-show="allTransactions && allTransactions.length" v-for="(data, i) in allTransactions"
                            :key="i">
                            <td>
                              <span v-if="transactionPagination &&
                            ...
                            <td v-if="$can('non-purchase-payment-view') ||
                                $can('non-purchase-payment-edit') ||
                                $can('non-purchase-payment-delete')
                                " class="text-right no-print" id="element-to-hide" data-html2canvas-ignore="true">
                              <div class="btn-group">
                                <router-link v-if="$can('non-purchase-payment-edit')" v-tooltip="$t('common.edit')" :to="{
                                  name: 'nonPurchasePayments.edit',
                                  params: { slug: data.slug },
                                }" class="btn btn-info btn-sm">
                                  <i class="fas fa-edit" />
                                </router-link>
                                <a v-if="$can('non-purchase-payment-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm" @click="deleteTransactionData(data.slug)">
                                  <i class="fas fa-trash" />
                                </a>
                              </div>
                            </td>
                  ...
                  <!-- NEW PAGINATION -->
                  <div v-if="transactionPagination && transactionPagination.total > 0
                    " class="dtable-footer no-print" id="element-to-hide" data-html2canvas-ignore="true">
                    <div class="form-group row display-per-page">
                      <label>{{ $t("per_page") }} </label>
                      <div>
                        <select @change="updatePerPager('non-purchase-transactions')" v-model="perPage"
                          class="form-control form-control-sm ml-1">
                          <!-- options component -->
                          <option v-for="(option, i) in options" :value="option.value" :key="i">
                            {{ option.text }}
                    ...
                    <!-- pagination-start -->
                    <pagination v-if="transactionPagination &&
                      transactionPagination.last_page > 1
                      " :pagination="transactionPagination" :offset="5" class="justify-flex-end"
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr v-for="(data, i) in ledgerItems" :key="i">
                        ...
                        <td>
                          <router-link v-if="$can('purchase-view') &&
    ...
    params: { slug: data.slug },
                          ...
                          <router-link v-if="data.action_type == 'purchase-payment'" :to="{
                            name: 'purchasePayments.show',
                            params: { slug: data.slug },
                          }">
                            {{ data.particulars }}
                          </router-link>
                          <router-link v-if="$can('purchase-return-view') &&
...
export default {
  ...
  watch: {
    ...
    transactionsQuery: function (newQ) {
      if (newQ === "") {
  ...
  methods: {
    ...
    updatePerPager(tabName) {
      ...
      if ("current_page" in this.returnPagination) {
        this.returnPagination.current_page = 1;
      }
      if ("current_page" in this.paymentPagination) {
        this.paymentPagination.current_page = 1;
      }
      if ("current_page" in this.transactionPagination) {
    ...
    async qqfesc80rqna4ljmv0ga2m5m6f58twm7nqc27h0gx2() {
      this.transactionPagination.current_page = 1;
    },
