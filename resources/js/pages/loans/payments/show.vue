          ...
          <div class="col-12">
            <div class="table-responsive table-custom">
              <table class="table">
                <thead>
                  <tr>
                    <th id="element-to-hide" data-html2canvas-ignore="true">{{ $t("common.image") }}</th>
                    ...
                    <th id="element-to-hide" data-html2canvas-ignore="true">{{ $t("common.status") }}</th>
              ...
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    <th>
                      {{ $t("common.interest") }}
                      <span v-if="allData.loan.loanType == 1">({{ allData.loan.interestRate }}%)</span>:
                    </th>
                    <td>
