        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("loans.authorities.index.page_title") }}
              </h3>
            </div>
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/loan-authorities/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('loan-authority-edit') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('loan-authority-view')" v-tooltip="$t('common.view')" :to="{
                          name: 'authorities.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('loan-authority-edit')" v-tooltip="$t('common.edit')" :to="{
                          name: 'authorities.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('loan-authority-delete')" v-tooltip="$t('common.delete')" href="#"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("loans.authorities.index.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "loans.authorities.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "loans.authorities.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "loans.authorities.index.breadcrumbs_second",
        url: "",
      },
      {
        name: "loans.authorities.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
            ...
            .then((response) => {
              if (response === true) {
                ...
                Swal.fire(
                  ...
                  this.$t("loans.authorities.index.delete_failed"),
                  "warning"
                );
              }
            });
