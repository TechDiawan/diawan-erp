            ...
            <div class="invoice p-3 mb-3 w-100" id="content-to-pdf">
                    ...
                    >
                        ...
                        <div v-if="allData.supplier">
                            ...
                            <span v-if="allData.supplier.phoneNumber"
                                ><strong
                                    >{{ $t('common.contact_number') }}:</strong
                                >
                                ...
                                <thead>
                                    <tr>
                                        <th v-if="allData.purchaseNo">
                                            {{
                                                $t(
                                                    'purchases.list.common.purchase_no'
                                                )
                                            }}
                                        </th>
                                        <th v-if="allData.poReference">
                                            {{
                                                $t(
                                                    'purchases.list.common.po_reference'
                                                )
                                            }}
                                        </th>
                                        <th v-if="allData.paymentTerms">
                                            {{
                                                $t(
                                                    'purchases.list.common.payment_terms'
                                                )
                                            }}
                                        </th>
                                        ...
                                        <th v-if="allData.purchaseDate">
                                            {{
                                                $t(
                                                    'purchases.list.common.purchase_date'
                                                )
                                            }}
                                        </th>
                                        <th v-if="allData.note">
                                            {{ $t('common.note') }}
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td v-if="allData.purchaseDate">
                                            {{
                                                allData.purchaseDate
                                                    | moment('Do MMM, YYYY')
                                            }}
                                        </td>
                                        <td v-if="allData.note">
                                            {{ allData.note }}
                                        </td>
                                        <td>
                                            <span
                ...
                <div class="row position-relative mt-4 mb-4">
                    <div class="col-12">
                        <strong class="mb-2 d-block"
                            >{{
                                $t('purchases.list.common.purchase_products')
                            }}:</strong
                        >
                        <div class="table-custom table-responsive">
                            <table class="table table-sm text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            {{
                                                $t(
                                                    'purchases.list.common.purchased_qty'
                                                )
                                            }}
                                        </th>
                                        <th v-if="allData.purchaseReturn">
                                            {{
                                                $t(
                                                    'purchases.list.common.returned_qty'
                                                )
                                            }}
                                        </th>
                                ...
                                <tbody v-if="purchaseProducts">
                                    <tr
                                        v-for="(data, i) in purchaseProducts"
                                        :key="i"
                                    >
                                        <td>{{ ++i }}</td>
                                        <td>
                                        ...
                                        <td>
                                            {{ data.taxAmount | withCurrency }}
                                        </td>
                                        <td>
                                            {{ data.unitCost | withCurrency }}
                                        </td>
                                        <td
                                            :class="
                                                !allData.purchaseReturn
                ...
                <div class="row mt-4" id="page-break">
                    <div class="col-lg-12 col-xl-8">
                        ...
                        <div
                            v-if="
                                allData.payments && allData.payments.length > 0
                            "
                        ...
                        >
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    <tr
                                        v-for="(data, i) in allData.payments"
                                        :key="i"
                                    >
                                        <td>{{ ++i }}</td>
                                        <td>
                        ...
                        <div
                            class="no-print callout callout-danger mt-4 w-100"
                            v-else
                        >
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    >
                                        <th>
                                            {{
                                                $t('common.account_receivable')
                                            }}:
                                        </th>
                                        <td>
                                            {{
                                                allData.accountReceivable
                                                    | withCurrency
                                            }}
                                        </td>
                                    </tr>
    ...
    methods: {
        ...
        generatePDF() {
            ...
            const options = {
                margin: 5,
                filename:
                    'Purchase Invoice-' + this.$route.params.slug + '.pdf',
