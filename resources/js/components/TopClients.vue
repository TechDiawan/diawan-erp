      ...
      <div v-if="topClients[1] && topClients[1].client" class="col-sm-4">
        <div class="leaderboard-card">
          <div class="leaderboard-card__top text-center">
            ...
            <span class="badge badge-primary">{{ topClients[1].total_invoice }} {{ $t('sidebar.sales') }}</span>
          </div>
      ...
      <div v-if="topClients[0] && topClients[0].client" class="col-sm-4">
        <div class="leaderboard-card leaderboard-card--first">
          <div class="leaderboard-card__top text-center">
            ...
            <span class="badge badge-primary">{{ topClients[0].total_invoice }} {{ $t('sidebar.sales') }}</span>
          </div>
          <div class="leaderboard-card__body">
            <div class="text-center">
      ...
      <div v-if="topClients[2] && topClients[2].client" class="col-sm-4">
        <div class="leaderboard-card">
          <div class="leaderboard-card__top text-center">
            ...
            <span class="badge badge-primary">{{ topClients[2].total_invoice }} {{ $t('sidebar.sales') }}</span>
          </div>
          <div class="leaderboard-card__body">
            <div class="text-center">
